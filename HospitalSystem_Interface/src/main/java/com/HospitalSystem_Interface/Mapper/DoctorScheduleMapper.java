...
public interface DoctorScheduleMapper {
    ...
    @Select("select * from v_doctorschedule ds where ds.doctor_id = #{param1} and ds.work_date >= #{param2} and ds.end_time_hour >= DATE_FORMAT(current_time, '%H') and ds.end_time_minute > DATE_FORMAT(current_time, '%i') and ds.work_date <= #{param3} and ds.valid_flag = 1")
